...
public class WeatherDetails extends AppCompatActivity {
    ...
    @BindView(R.id.textViewDay1)
    TextView textViewDay1;
    @BindView(R.id.textViewDay2)
    TextView textViewDay2;
    @BindView(R.id.textViewDay3)
    TextView textViewDay3;
    @BindView(R.id.textViewDay4)
    TextView textViewDay4;
    @BindView(R.id.textViewDay5)
    TextView textViewDay5;
    @BindView(R.id.imageViewDay1)
    ImageView imageViewDay1;
    @BindView(R.id.imageViewDay2)
    ImageView imageViewDay2;
    @BindView(R.id.imageViewDay3)
    ImageView imageViewDay3;
    @BindView(R.id.imageViewDay4)
    ImageView imageViewDay4;
    @BindView(R.id.imageViewDay5)
    ImageView imageViewDay5;
    @BindView(R.id.textViewMaxTempDay1)
    TextView textViewMaxTempDay1;
    @BindView(R.id.textViewMaxTempDay2)
    TextView textViewMaxTempDay2;
    @BindView(R.id.textViewMaxTempDay3)
    TextView textViewMaxTempDay3;
    @BindView(R.id.textViewMaxTempDay4)
    TextView textViewMaxTempDay4;
    @BindView(R.id.textViewMaxTempDay5)
    TextView textViewMaxTempDay5;
    @BindView(R.id.textViewMinTempDay1)
    TextView textViewMinTempDay1;
    @BindView(R.id.textViewMinTempDay2)
    TextView textViewMinTempDay2;
    @BindView(R.id.textViewMinTempDay3)
    TextView textViewMinTempDay3;
    @BindView(R.id.textViewMinTempDay4)
    TextView textViewMinTempDay4;
    @BindView(R.id.textViewMinTempDay5)
    TextView textViewMinTempDay5;
